...
Telegram bot commands are enabled by default for the configured `TELEGRAM_CHAT_ID`.

Telegram 봇 명령은 설정된 `TELEGRAM_CHAT_ID`에서 기본 활성화됩니다.
...
/messages on|off
/noti on|off
/mode full|redacted|sender_only
...
More command details: [docs/BOT_COMMANDS.md](docs/BOT_COMMANDS.md)
